...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    ux_hcd_synergy_asynchronous_endpoint_destroy        PORTABLE C      */
/*                                                           5.6          */ 
/*  AUTHOR                                                                */ 
/*                                                                        */ 
...
/*******************************************************************************************************************//**
 * @brief  This function will destroy an asynchronous endpoint. The control and bulk endpoints fall into
 *         this category.
 *
 ...
 * @retval UX_SUCCESS                  Asynchronous endpoint destroyed successfully.
 **********************************************************************************************************************/
...
TX_INTERRUPT_SAVE_AREA
    ...
    if (previous_ed == UX_NULL)
    {
        ...
        hcd_synergy -> ux_hcd_synergy_asynch_head_ed =  next_ed;
    }
    else
    {
    ...
    /* Reset the current ed processed and force the scheduler to restart from the beginning
       of the list.  */
    hcd_synergy -> ux_hcd_synergy_asynch_current_ed =  UX_NULL;       
