...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    ux_hcd_synergy_frame_number_set                     PORTABLE C      */
/*                                                           5.6          */ 
/*  AUTHOR                                                                */ 
/*                                                                        */ 
...
/*  CALLS                                                                 */ 
/*                                                                        */ 
/*    ux_hcd_synergy_register_write         Write to Synergy register     */
/*                                                                        */ 
/*  CALLED BY                                                             */ 
/*                                                                        */ 
/*    Synergy Controller Driver                                           */
...
/*******************************************************************************************************************//**
 * @brief  This function will set the current frame number to the one
 *         specified. This function is mostly used for isochronous purpos.es
 *
