...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    ux_dcd_synergy_buffer_ready_interrupt               PORTABLE C      */
/*                                                           5.6          */ 
/*  AUTHOR                                                                */ 
/*                                                                        */ 
...
VOID  ux_dcd_synergy_buffer_ready_interrupt(UX_DCD_SYNERGY *dcd_synergy, UX_DCD_SYNERGY_ED *ed, ULONG flag)
{
    ...
    synergy_brdy_register = ux_dcd_synergy_register_read(dcd_synergy, UX_SYNERGY_DCD_BRDYENB);
    ...
    ux_dcd_synergy_register_write(dcd_synergy, UX_SYNERGY_DCD_BRDYENB, (USHORT)synergy_brdy_register);
