...
#define UX_DCD_SYNERGY_INTERRUPT_STATUS_REGISTER 0x00f1
#else
#define UX_DCD_SYNERGY_INTERRUPT_STATUS_REGISTER 0x03ff
#endif
/*******************************************************************************************************************//**
 * @addtogroup sf_el_ux
 * @{
...
/*******************************************************************************************************************//**
 * @brief  This function clears a bit in a status register of the synergy.To clear the status bits,
...
VOID  ux_dcd_synergy_usb_status_register_clear(UX_DCD_SYNERGY *dcd_synergy, ULONG synergy_register, USHORT value)
{
    ...
    /* Clear register.  */
    *dcd_reg = (USHORT)UX_DCD_SYNERGY_INTERRUPT_STATUS_REGISTER & (USHORT)(~value);
}
/*******************************************************************************************************************//**
