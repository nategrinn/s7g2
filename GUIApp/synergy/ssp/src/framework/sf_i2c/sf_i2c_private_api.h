...
#ifndef SF_I2C_PRIVATE_API_H
#define SF_I2C_PRIVATE_API_H
...
ssp_err_t SF_I2C_Read(sf_i2c_ctrl_t * const p_ctrl,
                      uint8_t * const p_dest,
                      uint32_t const bytes,
                      bool const restart,
                      uint32_t const timeout);
ssp_err_t SF_I2C_Write(sf_i2c_ctrl_t * const p_ctrl,
                       uint8_t * const p_src,
                       uint32_t const bytes,
                       bool const restart,
                       uint32_t const timeout);
...
ssp_err_t SF_I2C_LockWait(sf_i2c_ctrl_t * const p_ctrl, uint32_t const timeout);

/* Common macro for SSP header files. There is also a corresponding SSP_HEADER macro at the top of this file. */
SSP_FOOTER

#endif /* SF_I2C_PRIVATE_API_H */
